...
from .views import HomeView, DetailProjectView, AddBlogView, EditPostView,DeletePostView, AddCategoryView, AddCommentView, LikeView, CategoryView, CategoryListView
